      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white border border-gray-200 p-10">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-3 tracking-tight">Sign In</h1>
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full flex items-center justify-center px-6 py-3 border border-gray-300 bg-white hover:bg-gray-50 transition font-medium text-gray-900"
            >
            ...
            <button
              ...
              className="w-full flex items-center justify-center px-6 py-3 bg-black hover:bg-gray-900 text-white transition font-medium"
            >
